...
class CrawlerService:
    ...
    def _fallback_products(self, query: str) -> List[Dict[str, Any]]:
        ...
        category_terms = {
            "electronics": ["phone", "laptop", "earbud", "earbuds", "headphone", "tv", "television", "ac", "air conditioner", "watch"],
            "fashion": ["shoe", "shirt", "kurta", "dress", "jeans", "sneaker"],
            "home": ["mixer", "grinder", "pillow", "fan", "kitchen", "home"],
            "beauty": ["serum", "foundation", "skincare", "lipstick", "moisturizer"],
            "sports": ["yoga", "dumbbell", "fitness", "running", "gym"],
        }
